...
class DeveloperProfilePageController extends AbstractController
{
    ...
    private function updatePageAttributes(): void
    {
        ...
        if ($currentUserResume) {
            $updatedResumeArray['developerCategory'] = $currentUserResume->getCategory();
            ...
            $updatedResumeArray['developerSkills'] = $currentUserResume->getSkills();
            $updatedResumeArray['english'] = $currentUserResume->getEnglishLevel();
            $updatedResumeArray['developerJobTypes'] = $currentUserResume->getJobTypes();
        } else {
            $updatedResumeArray['developerCategory'] = '';
            ...
            $updatedResumeArray['developerSkills'] = [];
            $updatedResumeArray['english'] = '';
            $updatedResumeArray['developerJobTypes'] = [];
        }
